...
func main() {
	...
	router.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"https://edukasi.kedaiprogrammer.com/", "https://cms.kedaiprogrammer.com/", "https://cms.kedaiprogrammer.com", "http://localhost:3501/", "http://localhost:3000/"},
